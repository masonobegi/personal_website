// Seed projects — Mason's real portfolio, loaded once into the projects store
// on first run. Editable afterwards in the admin (Projects tab). Image paths
// point at /images/… in public/.
...
export const SEED_PROJECTS = [
  {
    ...
    gallery: [
      ...
      { src: "/images/poochpit-admin-requests.png", caption: "Staff dashboard — approve or decline incoming appointment requests. (Client details redacted.)" },
      { src: "/images/poochpit-admin-calendar.png", caption: "The availability engine: set working days and block one-off or recurring time off." },
      { src: "/images/poochpit-admin-edit.png", caption: "No-code CMS: the owner edits copy, pricing, contact info, and policies herself." },
    ],
    liveUrl: "https://thepoochpitgrooming.com",
    liveLabel: "",
    codeUrl: "",
    status: "",
    featured: true,
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/obg-orders.png", caption: "Order management with Stripe checkout. (Customer details redacted.)" },
    ],
    liveUrl: "https://obgillustrator.com",
    liveLabel: "",
    codeUrl: "",
    status: "",
    featured: true,
  ...
  },
  {
    ...
    subsection: "",
    description:
      "A brand-forward marketing site and content platform for a wealth-management advisory firm — an advisory-team section, service specialties, a planning-philosophy series, a searchable insights library, and consultation booking, all editable from a password-protected admin.",
    long: [
      "Oswego Legacy Partners is a marketing website and content platform I built for a wealth-management advisory firm in Lake Oswego, Oregon. The public site presents the firm through a considered editorial brand: a home page, an advisory-team section, service specialties, a five-step planning approach, a planning-philosophy series, and a searchable, tag-filterable library of insights.",
      "Behind a login, a password-protected admin lets the firm manage site content, team members, and the article library without touching code — everything persisted in PostgreSQL, with iPhone HEIC image uploads converted in the browser. Consultation booking runs through Microsoft Bookings, lead-capture forms are delivered by email through Resend, and the site ships SEO metadata, a sitemap, and a live-generated llms.txt summary.",
      "Built with Next.js (App Router) and Tailwind CSS, backed by PostgreSQL and deployed on Railway.",
    ],
    ...
    gallery: [
      { src: "/images/oswego-home.png", caption: "The homepage — an editorial hero, who the firm serves, and an inline 'begin a conversation' form." },
      { src: "/images/oswego-about.png", caption: "About the firm and the advisory team, each advisor with a bio and one-click booking." },
      { src: "/images/oswego-services.png", caption: "Service specialties — from equity-compensation planning to estate and multigenerational planning." },
      { src: "/images/oswego-approach.png", caption: "The five-step planning approach." },
      { src: "/images/oswego-legacy-trilogy.png", caption: "The planning-philosophy series." },
      { src: "/images/oswego-library.png", caption: "The insights library: full-text search, tag filters, and sortable articles." },
    ],
    liveUrl: "https://oswegolegacypartners.com",
    liveLabel: "",
    codeUrl: "",
    status: "",
    featured: true,
  ...
  },
  {
    ...
    subsection: "",
    description:
      "A content-managed website for an independent jewelry & watch-repair shop — every word, photo, and service editable by the owner from a no-code dashboard, with SEO structured data built for the Google business panel.",
    long: [
      "The Jeweler is a production website I'm building for an independent jewelry and watch-repair shop inside Washington Square Mall in Tigard, Oregon. It's a marketing site with a purpose-built content management system: every heading, paragraph, photo, video, service, and legal page a visitor reads is editable by the owner from a password-protected dashboard — no code changes and no redeploy.",
      "I built it on Next.js (App Router) with a PostgreSQL backend. Uploaded photos and videos are stored in Postgres and served with HTTP Range support so iOS will play them; iPhone HEIC photos are converted to JPEG in the browser and large shots are downscaled before saving. The contact form writes every submission to the database before it attempts an email, so a provider outage can never lose a customer's message.",
      "It ships JSON-LD structured data — a JewelryStore profile with address, hours, and service catalog to power the Google business panel — plus a sitemap, robots rules, and a live-generated llms.txt summary. It's an active work in progress.",
    ],
    ...
    gallery: [
      { src: "/images/jeweler-home.png", caption: "The homepage — a full-bleed hero of the shop and a browse-by-category collection." },
      { src: "/images/jeweler-services.png", caption: "The services page: a twelve-item grid spanning repair, custom design, appraisal, and consignment." },
      { src: "/images/jeweler-gallery.png", caption: "A filterable gallery of custom designs, vintage & estate pieces, and restorations." },
      { src: "/images/jeweler-about.png", caption: "The About page — the shop's story and the jeweler himself." },
      { src: "/images/jeweler-contact.png", caption: "Visit & Contact: address, hours, and a form saved to the database before any email is sent." },
    ],
    liveUrl: "https://www.thejewelerservices.com",
    liveLabel: "",
    codeUrl: "",
    status: "In progress",
    featured: false,
  ...
  },
  {
    ...
    long: [
      ...
      "Matches play out on an arcade court with a retro LED scoreboard and a real game clock. Between rounds a roguelike progression loop lets you bank winnings, upgrade skills, steal players off the opposing roster, and gamble in a shop — while rivalry games and per-city difficulty modifiers ramp the pressure the deeper you push into the bracket.",
      "It's built in the Godot Engine with GDScript and exported natively to iOS (iPhone and iPad) as well as WebAssembly — a from-scratch build covering game feel, UI, opponent AI, and the full economy and progression systems, carried all the way through App Store review and release.",
    ],
    ...
    liveUrl: "https://apps.apple.com/us/app/basketrogue/id6762860660",
  ...
  },
  {
    ...
    subsection: "",
    description:
      "A full-stack PWA for cigar lovers: browse nearby lounges on an interactive map, track your collection, log tasting reviews, and follow store deals. Backed by a PostgreSQL API with JWT auth and store-owner dashboards, wrapped with Capacitor for native iOS/Android builds.",
    long: [
    ...
    liveUrl: "https://cigarmapsclaude-production.up.railway.app",
    liveLabel: "",
    codeUrl: "",
    status: "In progress",
    featured: false,
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/bootleggers.png", caption: "The main board — building and sprawling across the strip, with a trade underway." },
    ...
    liveUrl: "https://bootleggers.up.railway.app",
    liveLabel: "",
    codeUrl: "",
    status: "",
    featured: true,
  ...
  },
  {
    ...
    liveUrl: "https://discord-soccer-production.up.railway.app",
    liveLabel: "",
    codeUrl: "",
    status: "",
    featured: false,
  ...
  },
  {
    ...
    liveUrl: "https://bestof5-production-54ef.up.railway.app",
    liveLabel: "",
    codeUrl: "",
    status: "",
    featured: false,
