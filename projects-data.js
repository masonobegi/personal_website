...
const PROJECTS = [
  ...
  },
  {
    ...
    category: "Client Work",
    description:
      "A brand-forward marketing site and content platform for a wealth-management advisory firm — an advisory-team section, eight service specialties, a planning-philosophy series, a searchable insights library, and consultation booking, all editable from a password-protected admin.",
    long: [
      "Oswego Legacy Partners is a marketing website and content platform I built for a wealth-management advisory firm in Lake Oswego, Oregon. The public site presents the firm through a considered editorial brand: a home page, an advisory-team section where each advisor has a bio and one-click booking, eight service specialties, a five-step planning approach, a 'Legacy Trilogy' planning-philosophy series, and a searchable, tag-filterable library of insights and market articles.",
      "Behind a login, a password-protected admin lets the firm manage site content, team members, and the article library without touching code — everything persisted in PostgreSQL, with iPhone HEIC image uploads converted in the browser. Consultation booking runs through Microsoft Bookings, lead-capture forms are delivered by email through Resend, and the site ships SEO metadata, a sitemap, and a live-generated llms.txt summary for AI answer engines.",
      "Built with Next.js (App Router) and Tailwind CSS, backed by PostgreSQL and deployed on Railway — including the financial-services compliance disclosures (LPL Financial / FINRA / SIPC / CFP) the firm is required to display.",
    ],
    tags: ["Next.js", "React", "Tailwind", "PostgreSQL", "Resend"],
    tools: ["Next.js (App Router)", "React", "Tailwind CSS", "PostgreSQL", "Resend", "Microsoft Bookings", "Railway"],
    image: "images/oswego-home.png",
    gallery: [
      { src: "images/oswego-home.png", caption: "The homepage — an editorial hero over Oswego Lake, who the firm serves, and an inline 'begin a conversation' form." },
      { src: "images/oswego-about.png", caption: "About the firm: 'Why We Exist' and the advisory team, each advisor with a bio and one-click booking." },
      { src: "images/oswego-services.png", caption: "Eight service specialties — from equity-compensation planning for Nike and Intel professionals to estate and multigenerational planning." },
      { src: "images/oswego-approach.png", caption: "The five-step planning approach: Discovery, Analyze, Design, Implement, and Monitor & Adapt." },
      { src: "images/oswego-legacy-trilogy.png", caption: "The Legacy Trilogy — the firm's planning philosophy, built around Understanding, Purpose, and Relationships." },
      { src: "images/oswego-library.png", caption: "The insights library: full-text search, tag filters, and sortable articles, all managed from the admin." },
    ],
    video: "",
  ...
  },
  {
    ...
    tools: ["Next.js (App Router)", "React", "PostgreSQL", "Resend", "heic2any", "JSON-LD / SEO", "Railway"],
